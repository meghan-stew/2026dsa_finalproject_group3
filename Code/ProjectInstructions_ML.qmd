...
ggplot(data_model, aes(x = harvest_month, y = yield_mg_ha)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "lm")
...
```{r}
#to-do for meghan: pull open source data here for temperature based on lat/long and year for the study timeframe
