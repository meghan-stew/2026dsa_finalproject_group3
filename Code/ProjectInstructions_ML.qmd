...
ggplot(data_model, aes(x = planting_month, y = yield_mg_ha)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "lm")
...
While no strong pattern in yield based on plant month or harvest month is observed above, the range for maximum values seems to trend upward as harvest month increases to later, with higher value outliers around months 9 and 10. 
