...
final_corn_trainer <- readRDS("~/Crop_Soil_Stats/2026dsa_finalproject_group3/Data/final_corn_trainer.rds")
...
```{r}
test_pred <- predict(final_corn_trainer, new_data = final_test)
